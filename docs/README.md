...
- [Publisher Integration](guides/publisher-integration.md) — put ads on
  ...
  - [WordPress plugin — developer reference](../integrations/wordpress/README.md)
    — for people working on the plugin: architecture, code map, request
    lifecycles, state machines, ad-server contracts, WordPress gotchas,
    extension recipes, testing, build and release.
...
| Delivery controls | [FREQUENCY_CAPPING](design/FREQUENCY_CAPPING.md) *(design — not yet built)* |
